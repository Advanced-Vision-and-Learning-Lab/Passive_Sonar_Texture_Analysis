...
class SSTKAD_Loss(nn.Module):
    def __init__(self, task_num,task_flag=[True, False, True, True]):
        ...
        # self.T_prob_student = 1
        # self.T_prob_teacher = 1  
        self.T_prob_student = nn.Parameter(torch.ones(1))

        self.T_prob_teacher = nn.Parameter(torch.ones(1))
