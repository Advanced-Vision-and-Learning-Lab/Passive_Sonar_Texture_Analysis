...
def Parameters(args):
    ...
    out_channels = {"resnet50": 2048, "resnet18": 512, "efficientnet": 1280, 
                    ...
                    "regnet": 400, "TDNN": 256,"resnet101": 256}
    ...
    if scale == 1:
        ...
        in_channels = {"resnet50": 2048, "resnet18": 512, "efficientnet": 1280, "regnet": 400,
                       "resnet50_wide": 2048, "resnet101": 2048, "densenet121": 1024, 'TDNN': 4}
        kernel_size = {"resnet50": [4,4],  "resnet18": [4,4], "efficientnet": [4,4], "regnet": [4,4],
                       "resnet50_wide": [4,4], "resnet101": [4,4], "densenet121": [1,1],'TDNN': [3,3]}
    ...
    Data_dirs = {'DeepShip': './Datasets/synthetic_data_withoutgaussian_xai'}
    # Data_dirs = {'DeepShip': './Datasets/combined_scenario'}
